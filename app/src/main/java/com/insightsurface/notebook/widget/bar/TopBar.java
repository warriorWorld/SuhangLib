package com.insightsurface.notebook.widget.bar;
...
public class TopBar extends GradientBar {
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        float titleTextSize = ta.getDimension(
                R.styleable.home_top_bar_title_textSize, 18);
    ...
    public void setTitle_tv(int color){
        tipTV.setTextColor(getResources().getColor(color));
    }

    public void setTopBarBackgroundIcon(int color){
        topBarLayout.setBackgroundResource(color);
    }
