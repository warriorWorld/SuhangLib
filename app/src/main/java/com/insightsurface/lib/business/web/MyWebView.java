...
//        });
    ...
    public void setOnShowFileChooserListener(OnShowFileChooserListener onShowFileChooserListener) {
        mOnShowFileChooserListener = onShowFileChooserListener;
    }
    ...
    class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
            if (null != mOnShowFileChooserListener) {
                mOnShowFileChooserListener.showFileChooser(webView, filePathCallback, fileChooserParams);
                return true;
            } else {
